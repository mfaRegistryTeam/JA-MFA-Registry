...
class siteLabels:
    ...
    DatabaseURL= "mongodb://heroku_qc5l7qqd:or7uuplla29cvq7u647oo7ooap@ds163905.mlab.com:63905/heroku_qc5l7qqd/?retryableWrites=true"
    SessionType = "mongodb"
...
class databaseLabels:
    ...
    POTdescription='Stated Reason'

    AddressAbroad='Destination-Address'    
    CountryAbroad='Country'
    State ='Parish/State/Province/County'
